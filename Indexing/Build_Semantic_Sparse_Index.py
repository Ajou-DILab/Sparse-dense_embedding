...
# Single clustering over the full vocabulary -> one POS-agnostic medoid tensor
medoids_tensor = None

# Lemma -> synset lookup, built eagerly; rebuilt in main() if WordNet data
# wasn't available yet at import time.
try:
...
def main():
    global STOP, tokenizer, medoids_tensor, lemma2syns
